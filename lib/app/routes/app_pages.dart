...
class AppPages {
  ...
  static final routes = [
    GetPage(name: _Paths.courses, page: () => const CoursesView(), binding: CoursesBinding()),
    ...
    GetPage(name: _Paths.customBottomNav, page: () => const CustomBottomNavView(), binding: CustomBottomNavBinding()),
    ...
    GetPage(name: _Paths.recoveryOtp, page: () => const RecoveryOtpView(), binding: RecoveryOtpBinding()),
    GetPage(name: _Paths.createNewPassword, page: () => const CreateNewPasswordView(), binding: CreateNewPasswordBinding()),
    ...
    GetPage(name: _Paths.checkout, page: () => CheckoutView(), binding: CheckoutBinding()),
    GetPage(name: _Paths.bookingConfirmed, page: () => const BookingConfirmedView(), binding: BookingConfirmedBinding()),
    GetPage(name: _Paths.instructorDetails, page: () => const InstructorDetailsView(), binding: InstructorDetailsBinding()),
    GetPage(name: _Paths.myBookings, page: () => const MyBookingsView(), binding: MyBookingsBinding()),
    GetPage(name: _Paths.bookingDetails, page: () => const BookingDetailsView(), binding: BookingDetailsBinding()),
    GetPage(name: _Paths.topUpSuccess, page: () => const TopUpSuccessView()),
    GetPage(name: _Paths.productDetails, page: () => const ProductDetailsView(), binding: ProductDetailsBinding()),
    GetPage(name: _Paths.aboutUs, page: () => const AboutUsView(), binding: AboutUsBinding()),
    GetPage(name: _Paths.editProfile, page: () => const EditProfileView(), binding: EditProfileBinding()),
    GetPage(name: _Paths.memberships, page: () => const MembershipsView(), binding: MembershipsBinding()),
    GetPage(name: _Paths.membershipDetails, page: () => MembershipDetailsView(), binding: MembershipDetailsBinding()),
    GetPage(name: _Paths.termsConditions, page: () => const TermsConditionsView(), binding: TermsConditionsBinding()),
    GetPage(name: _Paths.wallet, page: () => const WalletView(), binding: WalletBinding()),
    GetPage(name: _Paths.orderHistory, page: () => const OrderHistoryView(), binding: OrderHistoryBinding()),
    GetPage(name: _Paths.filter, page: () => const FilterView(), binding: FilterBinding()),
    GetPage(name: _Paths.errorScreen, page: () => const ErrorScreenView(), binding: ErrorScreenBinding()),
    GetPage(name: _Paths.notFoundScreen, page: () => const NotFoundScreenView(), binding: NotFoundScreenBinding()),
  ];
}
