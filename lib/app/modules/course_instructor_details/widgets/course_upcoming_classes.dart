...
class CourseUpcomingClassesCard extends StatelessWidget {
  const CourseUpcomingClassesCard({super.key, required this.instructor});
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () {
            Get.toNamed(Routes.classDetails, arguments: id);
          },
          child: Container(
